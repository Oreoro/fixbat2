...
export const MANAGED_SECRETS = [
  ...
  },
  {
    ...
    label: "Claude model",
    help: "Defaults to claude-opus-5. claude-sonnet-5 is ~2.5x cheaper, claude-haiku-4-5 ~5x.",
    provider: "Anthropic",
    unlocks: "briefs",
  },
  {
    ...
    label: "Claude effort",
    help: "low, medium, high, xhigh or max. Defaults to high. Lower spends fewer thinking tokens.",
    provider: "Anthropic",
    unlocks: "briefs",
  },
  {
    ...
    help: "Any chat-completions endpoint — GLM, DeepSeek, Together, OpenRouter, your own vLLM. Include the version path.",
  ...
  },
  {
    ...
    help: "Used only when no Anthropic key is set.",
    provider: "OpenAI-compatible",
    unlocks: "briefs",
  },
  {
    ...
    help: "The model id that endpoint expects, e.g. glm-4.6 or deepseek-chat.",
    provider: "OpenAI-compatible",
    unlocks: "briefs",
  },
  {
    name: "OPENAI_PRICE_IN",
    label: "Input price per million tokens",
    help: "Optional. Without it and its output pair, spend on /metrics reads zero rather than a guess.",
    provider: "OpenAI-compatible",
    unlocks: "briefs",
  },
  {
    name: "OPENAI_PRICE_OUT",
    label: "Output price per million tokens",
    help: "Optional. Pairs with the input price above.",
    provider: "OpenAI-compatible",
    unlocks: "briefs",
  },
  {
  ...
  },
  {
    ...
    provider: "Pushed events",
    unlocks: "logs",
  },
  {
    name: "SENTRY_TOKEN",
    label: "Sentry auth token",
    help: "Reads errors from Sentry, which already marks which frames are yours.",
    provider: "Sentry",
    unlocks: "logs",
  },
  {
    name: "SENTRY_ORG",
    label: "Sentry organisation slug",
    help: "The org in your Sentry URL, e.g. acme.",
    provider: "Sentry",
    unlocks: "logs",
  },
  {
    ...
    help: "The project to read errors from.",
    provider: "Sentry",
    unlocks: "logs",
  },
  {
    name: "SENTRY_URL",
    label: "Sentry URL (self-hosted)",
    help: "Only for self-hosted Sentry. Defaults to https://sentry.io.",
    provider: "Sentry",
    unlocks: "logs",
  },
  {
    ...
    help: "Reads error-level logs from Datadog.",
    provider: "Datadog",
    unlocks: "logs",
  },
  {
    ...
    help: "Required alongside the API key for the logs search API.",
    provider: "Datadog",
    unlocks: "logs",
  },
  {
    name: "DATADOG_SITE",
    label: "Datadog site",
    help: "e.g. datadoghq.eu. Defaults to datadoghq.com.",
    provider: "Datadog",
    unlocks: "logs",
  },
  {
    name: "DATADOG_QUERY",
    label: "Datadog search query",
    help: "Overrides the default `status:error`. Narrow it to your services if the volume is large.",
    provider: "Datadog",
    unlocks: "logs",
  },
  {
    name: "GITLAB_TOKEN",
    label: "GitLab token",
    help: "Commit history, file contents and issues. Needs read_repository and api.",
    provider: "GitLab",
    unlocks: "repo",
  },
  {
    name: "GITLAB_URL",
    label: "GitLab URL (self-managed)",
    help: "Only for self-managed GitLab. Defaults to https://gitlab.com.",
    provider: "GitLab",
    unlocks: "repo",
  },
  {
    ...
    help: "Personal access token with Code (read) and Work Items (write).",
  ...
  },
  {
    ...
    help: "The org in dev.azure.com/<org>.",
    provider: "Azure DevOps",
    unlocks: "repo",
  },
  {
    ...
    help: "Project holding the repositories and work items.",
    provider: "Azure DevOps",
    unlocks: "repo",
  },
  {
    name: "JIRA_URL",
    label: "Jira site URL",
    help: "e.g. https://acme.atlassian.net. Files briefs as Jira issues.",
    provider: "Jira",
    unlocks: "tickets",
  },
  {
  ...
  },
  {
    ...
    help: "From id.atlassian.com — an API token, not a password.",
    provider: "Jira",
    unlocks: "tickets",
  },
  {
    ...
    help: "Where issues are created, e.g. OPS.",
    provider: "Jira",
    unlocks: "tickets",
  },
  {
  ...
  },
  {
    ...
    help: "Files briefs as Linear issues.",
    provider: "Linear",
    unlocks: "tickets",
  },
  {
    ...
    help: "The team issues are created in.",
    provider: "Linear",
    unlocks: "tickets",
  },
  {
